...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: NSDictionary?) -> Bool {
        ...
        if !Statics.userDefaults.boolForKey("initialized") {
            ...
            BookmarkDay.insert(8, month: 8, title: "Adar Yazad Jashan", isDefault: true)
            BookmarkDay.insert(10, month: 9, title: "Zarthost no Diso", isDefault: true)
            BookmarkDay.insert(21, month: 9, title: "Homaji ni Baj", isDefault: true)
    ...
    var persistentStoreCoordinator: NSPersistentStoreCoordinator? {
        if !(_persistentStoreCoordinator != nil) {
            let storeURL = self.applicationDocumentsDirectory.URLByAppendingPathComponent("parsi_calendar.sqlite")
            var error: NSError? = nil
